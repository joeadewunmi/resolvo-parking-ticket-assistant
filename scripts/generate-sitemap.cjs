...
const getStaticRoutes = () => {
  ...
  // All parking company routes - comprehensive list from route files
...
// Get council routes - make sure to use the full list from council-slugs.js
const getCouncilRoutes = () => {
  // Use the function from council-slugs to ensure format consistency
  ...
  // Make sure all councils are included
