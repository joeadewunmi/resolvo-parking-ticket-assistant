...
const UKParkingAdministration = () => {
  const companyName = "UK Parking Administration";
  const companySlug = "uk-parking-administration";
...
export default UKParkingAdministration;
