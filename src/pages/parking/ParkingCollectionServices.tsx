...
const ParkingCollectionServices = () => {
  const companyName = "Parking Collection Services";
  const companySlug = "parking-collection-services";
...
export default ParkingCollectionServices;
