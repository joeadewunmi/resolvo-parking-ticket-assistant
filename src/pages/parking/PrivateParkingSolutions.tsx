...
const PrivateParkingSolutions = () => {
  const companyName = "Private Parking Solutions";
  const companySlug = "private-parking-solutions";
...
export default PrivateParkingSolutions;
