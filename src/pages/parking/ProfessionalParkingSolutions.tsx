...
const ProfessionalParkingSolutions = () => {
  const companyName = "Professional Parking Solutions";
  const companySlug = "professional-parking-solutions";
...
export default ProfessionalParkingSolutions;
