...
const LeedsTeachingHospitals = () => {
  const companyName = "Leeds Teaching Hospitals NHS Trust";
  const companySlug = "leeds-teaching-hospitals";
...
export default LeedsTeachingHospitals;
