        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              title: "Resolve",
              description: " We will instantly generate an appeal letter tailored to your situation. You can review it, make any changes, and then use it to fight your ticket."
            }
          ].map((step, index) => (
