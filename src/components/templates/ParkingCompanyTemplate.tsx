          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-lg text-gray-600">
                {companyName} issues many parking tickets every day. But many of them can be challenged if you know the rules
              </p>
              <p className="mt-4 text-lg text-gray-600">
      ...
      <div className="py-24 bg-[#FFD700]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-primary text-center mb-12">
            How to Appeal a {companyName} Fine in 3 Steps
          </h2>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12 space-y-4">
            ...
            <div>
              <Link to="/appeal-hub" className="inline-flex items-center text-blue-600 hover:underline">
                Back to Appeal Hub
              </Link>
            </div>
          </div>
...
export default ParkingCompanyTemplate;
